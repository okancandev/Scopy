    ...
    public class UniTaskTrackerTreeView : TreeView
    {
        ...
        public UniTaskTrackerTreeView()
            : this(new TreeViewState(), new MultiColumnHeader(new MultiColumnHeaderState(new[]
            {
                ...
                new MultiColumnHeaderState.Column() { headerContent = new GUIContent("ananza")},
            })))
        {
        }
        ...
        protected override TreeViewItem BuildRoot()
        {
            ...
            children.Add(new UniTaskTrackerViewItem(1) { TaskType = "awaiterType", Status = "status".ToString(), Elapsed = 10.ToString("00.00"), Position = "stackTrace" });
